...
public class PacketInterceptor extends ChannelDuplexHandler {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        try {
            ...
            Main.getInst().getLogger().log(Level.SEVERE, "Error in onPacketInAsync().", e);
        }
    ...
    public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
        try {
            ...
            Main.getInst().getLogger().log(Level.SEVERE, "Error in onPacketOutAsync().", e);
        }
    ...
    public Object onPacketOutAsync(Player receiver, Channel channel, Object packet) {
        if (Classes.serverInfoClass.isInstance(packet)) {
            ...
            if(ev.getHover() != null) Reflection.getField(playersample.getClass(), "c", GameProfile[].class).set(playersample, Util.getHover(ev.getHover()));
            ...
            if(ev.getVersionEdit() != null) serverClass.set(ping, serverInvoker.invoke(Util.color(ev.getVersionEdit()), 0));
