...
public class MotdVersionEditedGetter extends SimpleExpression<String> {
    ...
    public String toString(@Nullable Event e, boolean b) {
        ...
        return ((ServerPingEvent) e).getVersionEdit();
    }

    @Override
    protected String[] get(Event e) {
        return new String[] {((ServerPingEvent) e).getVersionEdit()};
    }
}